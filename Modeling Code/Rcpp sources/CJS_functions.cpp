...
// [[Rcpp::export]]
double cpp_CJSloglik(NumericVector beta, NumericMatrix ch, NumericMatrix cap_X, NumericMatrix surv_X) {
  double xlnlik = 0;
  int nan = ch.nrow();
  int ns = ch.ncol();
...
// [[Rcpp::export]]
double cpp_CJSwrapper(NumericVector beta, NumericMatrix ch, NumericMatrix cap_X, NumericMatrix surv_X) {
  double lnlik = -1 * cpp_CJSloglik(beta, ch, cap_X, surv_X);
  return lnlik;
}

// [[Rcpp::export]]
List cpp_optim(NumericVector beta, NumericMatrix ch, NumericMatrix cap_X, NumericMatrix surv_X) {
  Rcpp::Environment stats("package:stats");
  Rcpp::Function optim = stats["optim"];
  
  Rcpp::List result = optim(Rcpp::_["par"] = beta,
                            Rcpp::_["fn"] = Rcpp::InternalFunction(&cpp_CJSwrapper),
                            Rcpp::_["method"] = "BFGS",
                            Rcpp::_["ch"] = ch,
                            Rcpp::_["cap_X"] = cap_X,
